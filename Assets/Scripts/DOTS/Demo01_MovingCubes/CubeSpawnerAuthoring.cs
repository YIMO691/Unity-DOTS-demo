...
namespace UnityDotsDemo.Demo01
{
    public sealed class CubeSpawnerAuthoring : MonoBehaviour
    {
        ...
        [Tooltip("Recommended test values: 1000, 5000, 10000, 50000.")]
        [Min(1)] public int SpawnCount = 1000;
        ...
        private sealed class CubeSpawnerBaker : Baker<CubeSpawnerAuthoring>
        {
            public override void Bake(CubeSpawnerAuthoring authoring)
            {
                ...
                AddComponent(spawnerEntity, new CubeSpawnerConfig
                {
                    ...
                    SpawnCount = math.max(1, authoring.SpawnCount),
